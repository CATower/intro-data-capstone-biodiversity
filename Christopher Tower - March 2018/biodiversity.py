...
conservation.columns = ['Conservation Status', 'Number of Species']
conservation
...
contingencyRM = [[30,146],[5, 73]]
chi2_contingency(contingencyRM)


# In[24]:


contingencyRB = [[75, 413],[5, 73]]
chi2_contingency(contingencyRB)
...
# (33.33% minimum detectable effect) 
# sample size per variation - 520 sheep
